...
```
java -Dspring.profiles.active=production -jar ./target/LMS-1-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=com.lms/lms-1
```
